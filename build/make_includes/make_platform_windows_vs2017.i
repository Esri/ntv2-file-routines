...
# ------------------------------------------------------------------------
# Windoze setup for Visual Studio 2017
# ------------------------------------------------------------------------
...
# ------------------------------------------------------------------------
# Using Microsoft Visual Studio 2017 (15.0)
#
# The following directories may have to be modified according to your
# install location:
#
VSInstallDir   := $(ProgramFiles)/Microsoft Visual Studio/2017/Professional
WindowsSdkDir  := $(ProgramFiles)/Windows Kits/10
MSBuildDir     := $(VSInstallDir)/MSBuild/15.0/Bin
...
PATH    := $(WindowsSdkDir)/bin/$(WindowsTargetPlatformVersion)/$(CPU);$(PATH)
