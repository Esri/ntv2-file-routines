...
# ------------------------------------------------------------------------
# Windoze setup for Visual Studio 2012
# ------------------------------------------------------------------------
...
# ------------------------------------------------------------------------
# Using Microsoft Visual Studio 2012 (11.0)
#
...
PATH    := $(WindowsSdkDir)/bin/x86;$(PATH)

ifeq ($(OS_ARCH), 64)
  LIB   := $(VSInstallDir)/VC/lib/amd64;$(WindowsSdkDir)/Lib/win8/um/x64

  VCC   := $(VSInstallDir)/VC/bin/x86_amd64/cl
  VLD   := $(VSInstallDir)/VC/bin/x86_amd64/link
  VLIB  := $(VSInstallDir)/VC/bin/x86_amd64/lib
  VRC   := $(WindowsSdkDir)/bin/x64/rc
  VMT   := $(WindowsSdkDir)/bin/x64/mt
else
  LIB   := $(VSInstallDir)/VC/lib;$(WindowsSdkDir)/Lib/win8/um/x86

  VCC   := $(VSInstallDir)/VC/bin/cl
  VLD   := $(VSInstallDir)/VC/bin/link
  VLIB  := $(VSInstallDir)/VC/bin/lib
  VRC   := $(WindowsSdkDir)/bin/x86/rc
  VMT   := $(WindowsSdkDir)/bin/x86/mt
endif
